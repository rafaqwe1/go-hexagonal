...
import (
	...
	"github.com/rafaqwe1/go-hexagonal/adapters/cli"
...
func TestRun(t *testing.T) {
	...
	resultExpected := fmt.Sprintf("Product ID %s with the name %s has been created the price %f as status %s", productId, productName, productPrice, productStatus)
